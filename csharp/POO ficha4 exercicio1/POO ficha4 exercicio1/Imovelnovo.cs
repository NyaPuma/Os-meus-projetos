namespace POO_ficha4_exercicio1
{
    ...
    // ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: //
    internal class ImovelNovo(string endereco, decimal preco, decimal valorAdicional)
            : Imovel(endereco, preco)
    {
        public decimal ValorAdicional { get; set; } = valorAdicional;

        public decimal ObterPrecoFinal() => Preco + ValorAdicional;

        public override void MostrarInformacoes()
        {
            Console.WriteLine($"[NOVO] Endereço: {Endereco} | Preço Base: {Preco:C} | Adicional: {ValorAdicional:C} | Final: {ObterPrecoFinal():C}");
        }
    }
}
