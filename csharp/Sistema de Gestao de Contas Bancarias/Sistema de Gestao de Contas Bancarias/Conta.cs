namespace Sistema_de_Gestao_de_Contas_Bancarias
{
    ...
    // ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: //
    internal class Conta(string numeroConta, string titular, decimal saldoInicial)
    {
        ...
        public virtual void Depositar(decimal valor)
        {
            ...
            Saldo += valor;
            Console.WriteLine($"✔ Depósito de {valor:C2} efetuado com sucesso.");
        }

        public virtual void Levantar(decimal valor)
        {
            if (valor <= 0) throw new ArgumentException("O valor do levantamento deve ser positivo.");
            if (valor > Saldo) throw new InvalidOperationException("Saldo insuficiente.");
            Saldo -= valor;
            Console.WriteLine($"✔ Levantamento de {valor:C2} efetuado com sucesso.");
        }
