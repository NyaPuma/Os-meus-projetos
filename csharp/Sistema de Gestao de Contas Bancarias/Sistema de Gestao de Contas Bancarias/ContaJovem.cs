namespace Sistema_de_Gestao_de_Contas_Bancarias
{
    ...
    // ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: //
    internal class ContaJovem(string numero, string titular, decimal saldo, decimal bonus) 
        : Conta(numero, titular, saldo)
    {
        ...
        {
            // Adiciona o bónus fixo ao valor depositado
            base.Depositar(valor + BonusDeposito);
        }

        public override void ExibirExtrato()
        {
            base.ExibirExtrato();
            Console.WriteLine($"Bónus por Depósito: {BonusDeposito:C2}");
        }
    }
}
