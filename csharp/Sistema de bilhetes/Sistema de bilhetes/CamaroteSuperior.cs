namespace Sistema_de_bilhetes
{
    ...
    // :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: //
    internal class CamaroteSuperior(decimal valor, decimal valorExtra, decimal valorAdicional)
        :VIP(valorAdicional, valor)
    {
        public decimal ValorExtra { get; set; } = valorExtra;

        public decimal GetValorTotalSuperior()
        {
            return ObterValorTotal() + ValorExtra;
        }

        public override void MostrarValor()
        {
            Console.WriteLine($"O valor do bilhete é: {GetValorTotalSuperior()}");
        }
    }
}
