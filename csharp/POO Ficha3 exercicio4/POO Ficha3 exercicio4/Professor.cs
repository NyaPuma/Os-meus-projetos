namespace POO_Ficha3_exercicio4
{
    ...
    // ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: //
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    internal class Professor(string nome, string registo)
    {
        // ===========================================================================
        // CLASSE: Professor
        // EXPLICAÇÃO: O professor leciona várias disciplinas (1 para Muitos).
        // ===========================================================================

        // Propriedades Auto-implementadas (forma simplificada de Get/Set do C#)
        public string Nome { get; set; } = nome;
        public string NumeroRegisto { get; set; } = registo;

        // Lista que armazena as disciplinas que este professor "possui"
        public List<Disciplina> DisciplinasLecionadas { get; set; } = [];

        // ===========================================================================

        // Adiciona uma disciplina à carga horária do professor
        ...
        {
            Console.WriteLine($"Professor: {Nome} | Registo: {NumeroRegisto}");
        }
    }
}