namespace POO_Contas_Bancarias
{
            ...
            )
    {
        ...
        public override void Depositar(decimal valor)
        {
            ...
            Saldo += valor;
            Console.WriteLine($"✔ Depósito de {valor:C2} efetuado.");
        }

        public override void Levantar(decimal valor)
        {
            if (valor > (Saldo + LimiteDescoberto))
                throw new InvalidOperationException("Excede o limite de descoberto.");
            Saldo -= valor;
            Console.WriteLine($"✔ Levantamento de {valor:C2} efetuado (Saldo: {Saldo:C2}).");
        }
    }
}
